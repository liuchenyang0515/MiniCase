...
public class WordAdapter extends ArrayAdapter<Word> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (listItemView == null) {
            ...
            viewHolder.miwokTextView = (TextView) listItemView.findViewById(R.id.miwok_text_view);
            // Find the TextView in the list_item.xml layout with the ID default_text_view.
            viewHolder.defaultTextView = (TextView) listItemView.findViewById(R.id.default_text_view);
            // Find the ImageView in the list_item.xml layout with the ID image.
            viewHolder.imageView = (ImageView) listItemView.findViewById(R.id.image);
    ...
    class ViewHolder {
        TextView miwokTextView, defaultTextView;
        ImageView imageView;
        View textContainer;
    }
}